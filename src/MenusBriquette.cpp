...
CEGUI::Window * Menus::MenusBriquette::creer_menus_briquettes(void){
    ...
    this->addBriquetteWdw = wmgr.createWindow("SleekSpace/Button",
            "Briquette/addBriquette");
    this->addBriquetteWdw->setText("0");
    this->addBriquetteWdw->setSize(CEGUI::UVector2(CEGUI::UDim(0.15, 0), CEGUI::UDim(0.3,0)));
    this->addBriquetteWdw->setPosition( CEGUI::UVector2( CEGUI::UDim( 0.05, 0.0f ),
            CEGUI::UDim( 0.32, 0.0f) ) );
    this->addBriquetteWdw->subscribeEvent(CEGUI::PushButton::EventClicked,
            CEGUI::Event::Subscriber(&Menus::MenusBriquette::addBriquette, this));
