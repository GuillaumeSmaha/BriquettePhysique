...
{
	std::cerr << "Le constructeur de SelectionMouse ne doit pas être appelé via createSingleton() et doit être appelé avec un Ogre::RenderWindow * en argument !" << std::endl << "Attention le singleton n'ayant pas été crée, il est fort possible d'avoir des erreurs de segmentation"  << std::endl ;
}
